...
_.extend(JsonParse.prototype, Base.prototype, {
    ...
    setOpcodeHandlers: function() {
        var self = this,globalSelf=this;
        // this._jsonReadSize = 2;
        this._loopbufferSize = 3;
        this._jsonReadSize = 4;
        this.unionBuffers = null;
        this._packetNum = 0;
        var unionBuffers = {};
            ...
            4: function(data) {
                ...
                function expectLowData(buffer,length) {
                    ...
                    if (buffer.length  >  length + sourceStart) {
                        ...
                        //_expect : function(data,opcode)
                        this._expect(nextBuffer);
                        // Garam.Logger().info('125 byte �̸��� ���� buffer Overflow �� ó����');
